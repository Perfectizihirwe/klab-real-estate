    ...
    const fetchData = () => {
        axios({
        method: "GET",
        url: "https://newsapi.org/v2/top-headlines?country=us&apiKey=598ff10007294bd486810f94fbc068a9",
        })
        .then((response) => {
    ...
    return (
        ...
        <div className="news-blog-header">
            <h1>Our Blog</h1>
            <p>
            The Latest Real Estate News And Insights From San Diego, And Beyond.
            </p>
        </div>
